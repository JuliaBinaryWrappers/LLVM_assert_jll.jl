# Autogenerated wrapper script for LLVM_assert_jll for x86_64-unknown-freebsd11.1-cxx11
export llvm_config, opt, llvm_mca, llc, clang, libclang, libllvm, liblto
