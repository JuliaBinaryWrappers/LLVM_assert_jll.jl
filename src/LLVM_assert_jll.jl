...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LLVM_assert_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1a4ff6f1-5156-5f9a-8aa5-a2840611f610"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LLVM_assert", artifacts_toml) for e in artifacts["LLVM_assert"]]
...
if best_platform === nothing
    @debug("Unable to load LLVM_assert; unsupported platform $(triplet(platform_key_abi()))")
else
